                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12">
                                                <div class="hero-slider-content hero-slider-content--left-space p-4" style="background-color: #343a4073!important;">
                                                    <p class="slider-title slider-title--big-light text-light">Wedding Organizer</p>
                                            ...
                                            <div class="single-grid-product">
                                                ...
                                                <div class="single-grid-product__content">
                                                    <div class="single-grid-product__category-rating">
                                                     ...
                                                     <a href="<?= base_url() ?>produk/<?= $val['produk_id'] ?>"><h5><?= $val['produk_nama'] ?></h5></a><br>
                                                     <a href="<?= base_url() ?>produk/<?= $val['produk_id'] ?>" class="text"><h5 class="text-primary">Rp. <?= nominal($val['produk_harga']) ?> .-</h5></a> <br>     
                                                     <a href="<?= base_url() ?>produk/<?= $val['produk_id'] ?>"><button class="btn btn-success">Pesan</button></a>
                                                </div>
                                            </div>
