...
<div class="row p-3" >
	<div class="col-md-12 p-5" >
		<h2 style="text-align: center;">KWITANSI PEMBAYARAN DP</h2>
		<p>
			Tanggal : <?= date_indo($pembayaran['pembayaran_tgl']) ?>
		</p>
		<p>
			Telah membayar DP sejumlah  <span class="text-success">Rp. <?= nominal($pembayaran['pembayaran_jumlah']) ?></span> dengan rincian sebagai berikut :
		</p>
