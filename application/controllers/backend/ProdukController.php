...
class ProdukController extends CI_Controller
{
	...
	{
		$data = array(
			'title' => 'Data Produk | Wedding Organizer',
	...
	public function tambah()
	{
		if (isset($_POST['simpan'])) {
			...
			$data = array(
				'title' => 'Tambah Data Produk | Wedding Organizer',
	...
	public function lihat($id){
		$data = array(
			'title' => 'Lihat Data Produk | Wedding Organizer',
	...
	public function update($id){
		if (isset($_POST['update'])){
			...
			$data = array(
				'title' => 'Update Data Produk | Wedding Organizer',
